        ...
        <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-zinc-400 text-lg leading-relaxed">
              <p>
                Hey! I'm a passionate developer currently in my{" "}
              ...
              <p>
                I have a deep focus on building strong foundations in{" "}
                <span className="text-indigo-400">Full-Stack Development</span>{" "}
                and <span className="text-purple-400">AI/ML</span>. My journey
                includes hands-on internship experience where I architected
                real-world backend systems and worked with modern web
                technologies.
              </p>
              <p>
                My long-term vision is to master the intersection of engineering
                and AI—specializing in{" "}
                <span className="text-white">
                  MERN, Django, GoLang, DevOps, and LLMs
                </span>
                .
              </p>
            </div>
            ...
            <div className="border-t border-zinc-800/50 mt-8 pt-8 text-zinc-400">
            ...
            <div className="pt-4 border-t border-zinc-800 mt-4">
              <p className="text-zinc-500 text-sm italic">
                Outside of tech, I explore Science, History, Cooking, and Video
                Games.
              </p>
            </div>
          </motion.div>
