...
const MagneticImage = ({ src, alt }) => {
  ...
  return (
    ...
    >
      <div className="absolute -inset-4 bg-gradient-to-tr from-white/5 via-white/5 to-white/5 rounded-[3rem] blur-2xl opacity-50 group-hover:opacity-100 transition duration-1000" />
...
export default function About() {
  ...
  const milestones = [
    { label: "Education", value: "3rd Year B.Tech @NST", icon: <BookOpen size={16} className="text-zinc-400" /> },
    { label: "Focus",     value: "AI & Scalable Systems", icon: <Sparkles size={16} className="text-zinc-400" /> },
  ];
      ...
      <main className="flex-grow relative z-10 pt-40 pb-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div ref={heroTextRef} className="lg:col-span-7 flex flex-col gap-8">
              <div className="space-y-4">
                <div className="flex items-center gap-3 text-zinc-500 font-bold tracking-[0.3em] uppercase text-xs">
              ...
              <div className="flex flex-wrap gap-6 items-center pt-4">
                <a href="https://drive.google.com/file/d/13pgBfgDfxREFM-vZvG8W4ZrQ4YFoGdUW/view?usp=sharing" target="_blank">
          ...
          <div ref={techSectionRef} className="mt-40 border-t border-white/5 pt-24">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              <div className="lg:col-span-4 space-y-4">
                <h2 className="text-xs font-bold text-zinc-500 tracking-[0.4em] uppercase">The Arsenal</h2>
          ...
          <div ref={interestsRef} className="mt-40">
            <div className="flex items-center gap-3 text-zinc-500 font-bold tracking-[0.3em] uppercase text-xs mb-10">
              <span className="w-8 h-[1px] bg-white/30" />
              Beyond the Terminal
            </div>
